...
public class ConnexionDEFilter implements Filter {
	...
	public void doFilter(ServletRequest requete, ServletResponse reponse, FilterChain ch)
		...
		if(!(username.equals(Memoire.getDirecteurE().getLoginDE())) || !(password.equals(Memoire.getDirecteurE().getPasswordDE()))) {
			out.println("<HTML>");
